 ...
 */
public class LoggerImpl implements Logger, Initializable {
    ...
    LoggerImpl(org.slf4j.Logger delegate) {
    ...
    public void initialize(Object... objects) {
        if (objects != null && objects.length > 0) {
            ...
            if (object instanceof Class<?>) {
                delegate = org.slf4j.LoggerFactory.getLogger((Class<?>) object);
            } else if (object instanceof String) {
                delegate = org.slf4j.LoggerFactory.getLogger((String) object);
            } else {
                throw new IllegalArgumentException("Unsupported argument type: " + object.getClass());
            }
        }
    }
    ...
    private static boolean shouldForward() {
        return !ServiceLocator.current().isQuiet();
    }
    ...
    private static net.microfalx.lang.Logger getLogger() {
        ServiceLocatorImpl serviceLocator = (ServiceLocatorImpl) ServiceLocator.current();
